...
import com.udinus.aplikasimobile.databinding.ActivityKhsEditBinding;
...
public class KhsEdit extends AppCompatActivity {

    private ActivityKhsEditBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKhsEditBinding.inflate(getLayoutInflater());
