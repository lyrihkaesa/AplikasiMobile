...
import com.udinus.aplikasimobile.databinding.ActivityKhsEntryBinding;
...
public class KhsEntry extends AppCompatActivity {

    private ActivityKhsEntryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKhsEntryBinding.inflate(getLayoutInflater());
